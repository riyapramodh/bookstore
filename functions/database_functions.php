<?php
	function db_connect(){
		// $cloudSqlConnectionName = 'pivotal-nebula-401108:us-central1:root-1';
		// $conn = mysqli_connect(null, "root", "", "www_project", null, "/cloudsql/{$cloudSqlConnectionName}");
		$conn = mysqli_connect("35.232.253.64", "root", "", "www_project");
		if(!$conn){
